...
const emailAccountSchema = z.object({
  ...
  filterMode: z.enum(["open", "allowlist", "blocklist"]).optional().default("open"), // open=all, allowlist=only listed, blocklist=all except listed
  allowFrom: z.array(z.string()).optional(), // emails/patterns to allow (e.g., "user@example.com", "*@company.com")
  blockFrom: z.array(z.string()).optional(), // emails/patterns to block (always checked first)
